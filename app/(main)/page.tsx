    ...
    <div className="relative flex grow flex-col">
      ...
      <div className="isolate flex h-full grow flex-col">
        ...
        <div className="mx-auto mt-12 w-full max-w-5xl">
          <h2 className="mb-4 text-center text-2xl font-bold">All Apps</h2>
          {loadingApps ? (
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {chats.map((chat) => (
                <div
                  key={chat.id}
                  className="block cursor-pointer rounded-lg border border-gray-200 bg-white p-4 shadow transition hover:shadow-lg"
